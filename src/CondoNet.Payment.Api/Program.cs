...
try
{
    ...
    builder.Services.AddDbContext<PaymentDbContext>(options => options.UseSqlServer(builder.Configuration.GetConnectionString("DefaultConnection"), b => b.MigrationsAssembly("CondoNet.Payment.Infrastructure")));
    ...
    app.UseSwagger();
    app.UseSwaggerUI(c => { c.SwaggerEndpoint("v1/swagger.json", "CondoNet Payment API V1"); c.RoutePrefix = "swagger"; });
